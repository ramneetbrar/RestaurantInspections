package com.ramneet.myapplication.cmpt276.UI;
...
import com.ramneet.myapplication.cmpt276.model.Inspection;
import com.ramneet.myapplication.cmpt276.model.Restaurant;
import com.ramneet.myapplication.cmpt276.model.RestaurantManager;
...
public class MainActivity extends AppCompatActivity implements jadapter.OnNoteListener, AdapterView.OnItemSelectedListener {
    ...
    public static List<Integer> Hazards=new ArrayList<>();
    public static List<Integer> numcritical=new ArrayList<>();
    public static List<Boolean> favourite =new ArrayList<>();
